import {
  ...
  useLoaderData,
  useNavigation, // Importar useNavigation
...
export default function EdidtProduct() {
  ...
  const isSubmitting = navigation.state === "submitting"; // Estado de envío
        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/50 overflow-hidden">
                    ...
                    <div className="">
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        <p className="text-slate-300 text-sm sm:text-base">
                          Fill in the details to edit your product
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <Form className="p-6 space-y-6" method="POST">
              <ProductForm  product={product} showAvailability />
              ...
              <div className="pt-2 text-center">
                <p className="text-slate-500 text-sm">
                  🚀 Your product will be available immediately after update
                </p>
              </div>
            </Form>
          </div>
